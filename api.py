...
def load_models():
    ...
    try:
        # Load compressed models using joblib (from the same directory)
        rf_min = joblib.load("rf_min_compressed.pkl")
        rf_max = joblib.load("rf_max_compressed.pkl")
        rf_modal = joblib.load("rf_modal_compressed.pkl")
        scaler = joblib.load("scaler_compressed.pkl")

        # Load encoders using pickle (from the models folder)
        encoders = {}
