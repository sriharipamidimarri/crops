...
#     joblib.dump(rf_min, os.path.join(MODEL_DIR, "rf_min.pkl"), compress=6)  # Compression Level 3 (balanced)
#     joblib.dump(rf_max, os.path.join(MODEL_DIR, "rf_max.pkl"), compress=6)
#     joblib.dump(rf_modal, os.path.join(MODEL_DIR, "rf_modal.pkl"), compress=6)
